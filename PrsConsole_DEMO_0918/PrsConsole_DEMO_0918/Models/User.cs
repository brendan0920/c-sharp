...
namespace PrsConsole_DEMO_0918.Models;
...
public partial class User
{
    ...
    // constructor
    public User (string username, string password, string firstName, string lastName, string email, bool reviewer, bool admin)
    {
        Username = username;
        Password = password;
        FirstName = firstName;
