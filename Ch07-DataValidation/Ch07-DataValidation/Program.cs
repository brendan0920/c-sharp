namespace Ch07_DataValidation
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            double price = GetDouble("Enter price: ", 1, 100.0);
            Console.WriteLine($"price is {price}");9
        ...
        // ++++++++++++++++++ GetDouble method which uses data validate, rather than exception handling ++++++++++++++++++++
