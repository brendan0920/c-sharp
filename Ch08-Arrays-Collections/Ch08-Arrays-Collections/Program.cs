...
namespace Ch08_Arrays_Collections
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // create 2x2 aaray of our names w/ a header
            ...
            namesTable[3, 0] = "Graham";
            namesTable[3, 1] = "Arnett";
            namesTable[4, 0] = "Sarika";
            namesTable[4, 1] = "Srivestava";
            namesTable[5, 0] = "Brandon";
            namesTable[5, 1] = "Moore";
            namesTable[6, 0] = "Holly";
            namesTable[6, 1] = "Hoffman";
            namesTable[7, 0] = "Brendan";
            namesTable[7, 1] = "Keam";
            ...
            { 
                for (int j = 0; j < namesTable[i, j].GetLength(1); j++)
                {
            ...
            Console.WriteLine($"position of Graham: {Array.BinarySearch(names, "Brendan")}");
            ...
            movieTitles.Add("Batman; Dark Knight");
